function [IGA,BCs] = Car_Structure()
...
B_21 = [B_11(1,1)                 B_11(1,2);    
        (B_11(1,1)+B_1(1,1))/2    (B_11(1,2)+B_1(1,2))/2; 
        B_1(1,1)                  B_1(1,2);
      ];
...
B_22 = [B_12(1,1)                 B_12(1,2);    
        (B_12(1,1)+B_2(1,1))/2    (B_12(1,2)+B_2(1,2))/2; 
        B_2(1,1)                  B_2(1,2);
      ];
...
B_23 = [B_13(1,1)                 B_13(1,2);    
        (B_13(1,1)+B_3(1,1))/2    (B_13(1,2)+B_3(1,2))/2; 
        B_3(1,1)                  B_3(1,2);
      ];
...
B_24 = [B_14(1,1)                 B_14(1,2);    
        (B_14(1,1)+B_4(1,1))/2    (B_14(1,2)+B_4(1,2))/2; 
        B_4(1,1)                  B_4(1,2);
      ];
...
B_25 = [B_15(1,1)                 B_15(1,2);    
        (B_15(1,1)+B_5(1,1))/2    (B_15(1,2)+B_5(1,2))/2; 
        B_5(1,1)                  B_5(1,2);
      ];
...
uKnot_26 = [0 0 0 1 1 1];
B_26 = [B_16(1,1)                 B_16(1,2);    
        (B_16(1,1)+B_6(1,1))/2    (B_16(1,2)+B_6(1,2))/2; 
        B_6(1,1)                  B_6(1,2);
      ];
weights_26 = ones(length(B_26),1);
% figure
% plotNurbs(uKnot_26,p,weights_26,300,B_26)

uKnot_27 = [0 0 0 1 1 1];
B_27 = [B_17(1,1)                 B_17(1,2);    
        (B_17(1,1)+B_7(1,1))/2    (B_17(1,2)+B_7(1,2))/2; 
        B_7(1,1)                  B_7(1,2);
      ];
weights_27 = ones(length(B_27),1);
% figure
% plotNurbs(uKnot_27,p,weights_27,300,B_27)

uKnot_28= [0 0 0 1 1 1];
B_28 = [B_18(1,1)                 B_18(1,2);    
        (B_18(1,1)+B_8(1,1))/2    (B_18(1,2)+B_8(1,2))/2; 
        B_8(1,1)                  B_8(1,2);
      ];
weights_28 = ones(length(B_28),1);
% figure
% plotNurbs(uKnot_28,p,weights_28,300,B_28)

uKnot_29 = [0 0 0 1 1 1];
B_29 = [B_19(1,1)                 B_19(1,2);    
        (B_19(1,1)+B_9(1,1))/2    (B_19(1,2)+B_9(1,2))/2; 
        B_9(1,1)                  B_9(1,2);
      ];
weights_29 = ones(length(B_29),1);
% figure
% plotNurbs(uKnot_29,p,weights_29,300,B_29)

uKnot_30 = [0 0 0 1 1 1];
B_30 = [B_20(1,1)                 B_20(1,2);    
        (B_20(1,1)+B_10(3,1))/2   (B_20(1,2)+B_10(3,2))/2; 
        B_10(3,1)                 B_10(3,2);
      ];
weights_30 = ones(length(B_30),1);
% figure
% plotNurbs(uKnot_30,p,weights_30,300,B_30)
...
B_1_s   = [B_21(3,:)  ;  B_1(2,:)                                      ; B_22(3,:);
           B_21(2,:)  ; [(B_11(2,1)+B_1(2,1))/2,(B_11(2,2)+B_11(2,2))/2]  ; B_22(2,:); 
           B_21(1,:)  ;  B_11(2,:)                                      ; B_22(1,:);
           ];
...
B_2_s   = [ B_22(3,:) ;  B_2(2,:)                                     ; B_23(3,:);
             B_22(2,:) ; [(B_2(2,1)+B_12(2,1))/2,(B_2(2,2)+B_12(2,2))/2] ; B_23(2,:); 
            B_22(1,:) ; B_12(2,:)                                   ; B_23(1,:)];
...
B_3_s = [ B_23(3,:) ; B_3(2,:)                                     ; B_24(3,:);
          B_23(2,:)  ; [(B_23(2,1)+B_24(2,1))/2,(B_23(2,2)+B_24(2,2))/2] ; B_24(2,:); 
          B_13(1,:)  ;  B_13(2,:)                                     ; B_13(3,:)];
...
B_4_s = [ B_4(1,:) ;    B_4(2,:)                                         ; B_4(3,:);
          B_24(2,:)  ; [(B_24(2,1)+B_25(2,1))/2,(B_24(2,2)+B_25(2,2))/2] ; B_25(2,:); 
          B_14(1,:)  ;   B_14(2,:)                                       ; B_14(3,:)];
...
B_5_s = [ B_15(3,:) ;    B_15(2,:)                                        ; B_15(1,:);
          B_26(2,:)  ; [(B_5(2,1)+B_15(2,1))/2,(B_15(2,2)+B_5(2,2))/2]  ; B_25(2,:); 
          B_5(3,:)  ;   B_5(2,:)                                          ; B_5(1,:)];
...
B_6_s = [ B_6(1,:) ;    B_6(2,:)                                     ; B_6(3,:);
          B_26(2,:)  ; [(B_6(2,1)+B_16(2,1))/2,(B_6(2,2)+B_16(2,2))/2] ; B_27(2,:); 
          B_16(1,:)  ;   B_16(2,:)                                     ; B_16(3,:)];
...
B_7_s = [ B_27(3,:) ;    B_7(2,:)                                         ; B_28(3,:);
          B_27(2,:)  ; [(B_7(2,1)+B_17(2,1))/2,(B_7(2,2)+B_17(2,2))/2] ; B_28(2,:); 
          B_27(1,:)  ;   B_17(2,:)                                       ; B_17(3,:)];
...
B_8_s = [ B_8(1,:) ;    B_8(2,:)                                         ; B_8(3,:);
          B_28(2,:)  ; [(B_8(2,1)+B_18(2,1))/2,(B_8(2,2)+B_18(2,2))/2] ; B_29(2,:); 
          B_18(1,:)  ;   B_18(2,:)                                       ; B_18(3,:)];
...
B_9_s = [ B_19(3,:) ;    B_19(2,:)                                         ; B_19(1,:);
          B_30(2,:)  ; [(B_19(2,1)+B_9(2,1))/2,(B_19(2,2)+B_9(2,2))/2] ; B_29(2,:); 
          B_9(3,:)  ;   B_9(2,:)                                       ; B_9(1,:)];
...
B_10_s = [B_20(3,:) ;    B_20(2,:)                                      ; B_20(1,:);
          B_21(2,:)  ; [(B_21(2,1)+B_30(2,1))/2,(B_21(2,2)+B_30(2,2))/2] ; B_30(2,:); 
          B_10(1,:)  ;   B_10(2,:)                                         ; B_10(3,:)];
