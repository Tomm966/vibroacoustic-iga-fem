function [NURBS] = generateNURBSDataCylinder(R,L)
...
% OUTPUT:
% NURBS: A structure containing data for five NURBS solids, including:
...
% controlPts: Control points for the solid.
    ...
    fac = 1/sqrt(2);
    weights_1([5,8,14,17,23,26]) = fac;
    B_1= [ -Ri  0   0;-Ri/2  Ri/2  0;0  Ri  0;
                 -Rii 0   0;-Rii Rii 0;0  Rii 0;
                 -R   0   0;-R   R   0;0   R   0;
                  ...
                  -Ri  0  hL;-Ri/2  Ri/2  hL; 0  Ri  hL;
                 -Rii 0   hL;-Rii Rii hL; 0  Rii hL;
                 -R   0   hL;-R   R   hL; 0   R   hL;
                 ...
                 -Ri  0   L;-Ri/2  Ri/2  L; 0  Ri  L;
    ...
    fac = 1/sqrt(2);
    weights_2([5,8,14,17,23,26]) = fac;
    B_2=[0   Ri 0; Ri/2 Ri/2 0;Ri    0 0;
            0  Rii 0;Rii Rii 0;Rii 0 0;
            0  R 0;R  R 0;R   0 0;
            ...
            0   Ri hL; Ri/2 Ri/2 hL;Ri 0 hL;
            0  Rii hL;Rii Rii hL;Rii 0 hL;
            0  R hL;R  R hL;R   0 hL;
            ...
             0   Ri L; Ri/2 Ri/2 L;Ri 0 L;
    ...
    fac = 1/sqrt(2);
    weights_3([5,8,14,17,23,26]) = fac;
    B_3=[0   -Ri 0; -Ri/2 -Ri/2 0;-Ri    0 0;
            0  -Rii 0;-Rii -Rii 0;-Rii 0 0;
            0  -R 0;-R  -R 0;-R   0 0;
            ...
            0   -Ri hL; -Ri/2 -Ri/2 hL;-Ri 0 hL;
    ...
    fac = 1/sqrt(2);
    weights_4([5,8,14,17,23,26]) = fac;
    B_4= [ Ri  0   0;Ri/2  -Ri/2  0;0  -Ri  0;
                 Rii 0   0;Rii -Rii 0;0  -Rii 0;
                 R   0   0;R   -R   0;0   -R   0;
                  ...
                  Ri  0  hL;Ri/2  -Ri/2  hL; 0  -Ri  hL;
                 ...
                 R   0   L;R   -R   L;0   -R   L];
    %---- Fifth volume ---------------------------------------------------%
    uKnot_5 = [0 0 0 1 1 1]; %starting knot vector %%xsi
    vKnot_5 = [0 0 0 1 1 1]; %starting knot vector %%ni
    wKnot_5 = [0 0 0 1 1 1]; %starting knot vector %%eta
    noPtsX_5      = length(uKnot_5)-p-1;
    noPtsY_5      = length(vKnot_5)-q-1;
    noPtsZ_5      = length(wKnot_5)-r-1;
    weights_5 = ones(1,noPtsX_5*noPtsY_5*noPtsZ_5)';
    B_5= [ 0  -Ri 0; Ri/2  -Ri/2 0; Ri   0 0;
          -Ri/2  -Ri/2 0; 0  0   0; Ri/2  Ri/2 0;
          -Ri    0 0; -Ri/2   Ri/2 0; 0   Ri 0;...
          
           0  -Ri hL; Ri/2  -Ri/2 hL; Ri   0 hL;
          -Ri/2  -Ri/2 hL; 0  0   hL; Ri/2  Ri/2 hL;
          -Ri    0     hL; -Ri/2   Ri/2 hL; 0   Ri hL;
          
           0  -Ri L; Ri/2  -Ri/2 L; Ri   0 L;
          -Ri/2  -Ri/2 L; 0  0   L; Ri/2  Ri/2 L;
          -Ri    0 L; -Ri/2   Ri/2 L; 0   Ri L];
    %---- Solid 1 --------------------------------------------------------%
    ...
    NURBS(4).r = r; 
    %---- Solid 5 --------------------------------------------------------%
    NURBS(5).uknot = uKnot_5;
    NURBS(5).vknot = vKnot_5;
    NURBS(5).wknot = wKnot_5;
    NURBS(5).noPtsX = noPtsX_5;
    NURBS(5).noPtsY = noPtsY_5;
    NURBS(5).noPtsZ = noPtsZ_5;
    NURBS(5).weights= weights_5;
    NURBS(5).controlPts = B_5;
    NURBS(5).p = p;
    NURBS(5).q = q;
    NURBS(5).r = r; 
end
