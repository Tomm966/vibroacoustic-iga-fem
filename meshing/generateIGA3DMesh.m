...
uniqueUKnots   = unique(uKnot); %vettore knot in direzione x
uniqueVKnots   = unique(vKnot); %vettore knot in direzione y
uniqueWKnots   = unique(wKnot); %vettore knot in direzione z
